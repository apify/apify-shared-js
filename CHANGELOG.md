...
--------|---------|----------
`@apify/consts` | 2.29.0 | [CHANGELOG](./packages/consts/CHANGELOG.md)
...
`@apify/input_schema` | 3.7.0 | [CHANGELOG](./packages/input_schema/CHANGELOG.md)
`@apify/input_secrets` | 1.1.52 | [CHANGELOG](./packages/input_secrets/CHANGELOG.md)
`@apify/log` | 2.5.4 | [CHANGELOG](./packages/log/CHANGELOG.md)
`@apify/markdown` | 2.1.24 | [CHANGELOG](./packages/markdown/CHANGELOG.md)
`@apify/payment_qr_codes` | 0.2.1 | [CHANGELOG](./packages/payment_qr_codes/CHANGELOG.md)
`@apify/pseudo_url` | 2.0.44 | [CHANGELOG](./packages/pseudo_url/CHANGELOG.md)
...
`@apify/utilities` | 2.10.5 | [CHANGELOG](./packages/utilities/CHANGELOG.md)
