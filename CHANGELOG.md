...
`@apify/input_schema` | 3.25.6 | [CHANGELOG](./packages/input_schema/CHANGELOG.md)
`@apify/input_secrets` | 1.2.21 | [CHANGELOG](./packages/input_secrets/CHANGELOG.md)
`@apify/json_schemas` | 0.10.0 | [CHANGELOG](./packages/json_schemas/CHANGELOG.md)
`@apify/log` | 2.5.28 | [CHANGELOG](./packages/log/CHANGELOG.md)
`@apify/markdown` | 3.0.45 | [CHANGELOG](./packages/markdown/CHANGELOG.md)
...
`@apify/utilities` | 2.25.0 | [CHANGELOG](./packages/utilities/CHANGELOG.md)
