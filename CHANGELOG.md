...
--------|---------|----------
`@apify/consts` | 2.28.0 | [CHANGELOG](./packages/consts/CHANGELOG.md)
...
`@apify/input_schema` | 3.5.17 | [CHANGELOG](./packages/input_schema/CHANGELOG.md)
`@apify/input_secrets` | 1.1.50 | [CHANGELOG](./packages/input_secrets/CHANGELOG.md)
`@apify/log` | 2.5.2 | [CHANGELOG](./packages/log/CHANGELOG.md)
`@apify/markdown` | 2.1.22 | [CHANGELOG](./packages/markdown/CHANGELOG.md)
`@apify/payment_qr_codes` | 0.2.1 | [CHANGELOG](./packages/payment_qr_codes/CHANGELOG.md)
`@apify/pseudo_url` | 2.0.42 | [CHANGELOG](./packages/pseudo_url/CHANGELOG.md)
...
`@apify/utilities` | 2.10.3 | [CHANGELOG](./packages/utilities/CHANGELOG.md)
