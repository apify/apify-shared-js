...
--------|---------|----------
`@apify/consts` | 2.3.0 | [CHANGELOG](./packages/consts/CHANGELOG.md)
...
`@apify/log` | 2.1.4 | [CHANGELOG](./packages/log/CHANGELOG.md)
`@apify/markdown` | 2.0.8 | [CHANGELOG](./packages/markdown/CHANGELOG.md)
`@apify/payment_qr_codes` | 0.2.0 | [CHANGELOG](./packages/payment_qr_codes/CHANGELOG.md)
`@apify/pseudo_url` | 2.0.5 | [CHANGELOG](./packages/pseudo_url/CHANGELOG.md)
...
`@apify/utilities` | 2.2.1 | [CHANGELOG](./packages/utilities/CHANGELOG.md)
