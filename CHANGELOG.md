...
`@apify/log` | 2.0.0 | [CHANGELOG](./packages/log/CHANGELOG.md)
`@apify/markdown` | 2.0.0 | [CHANGELOG](./packages/markdown/CHANGELOG.md)
`@apify/payment_qr_codes` | 0.2.0 | [CHANGELOG](./packages/payment_qr_codes/CHANGELOG.md)
`@apify/pseudo_url` | 2.0.0 | [CHANGELOG](./packages/pseudo_url/CHANGELOG.md)
...
`@apify/utilities` | 2.0.0 | [CHANGELOG](./packages/utilities/CHANGELOG.md)
