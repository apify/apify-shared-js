...
`@apify/input_secrets` | 1.1.32 | [CHANGELOG](./packages/input_secrets/CHANGELOG.md)
`@apify/log` | 2.3.0 | [CHANGELOG](./packages/log/CHANGELOG.md)
`@apify/markdown` | 2.1.6 | [CHANGELOG](./packages/markdown/CHANGELOG.md)
`@apify/payment_qr_codes` | 0.2.0 | [CHANGELOG](./packages/payment_qr_codes/CHANGELOG.md)
`@apify/pseudo_url` | 2.0.29 | [CHANGELOG](./packages/pseudo_url/CHANGELOG.md)
...
`@apify/utilities` | 2.7.9 | [CHANGELOG](./packages/utilities/CHANGELOG.md)
