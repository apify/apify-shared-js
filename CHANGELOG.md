...
--------|---------|----------
`@apify/consts` | 1.4.0 | [CHANGELOG](./packages/consts/CHANGELOG.md)
...
`@apify/hubspot_client` | 1.2.0 | [CHANGELOG](./packages/hubspot_client/CHANGELOG.md)
`@apify/image_proxy_client` | 1.0.1 | [CHANGELOG](./packages/image_proxy_client/CHANGELOG.md)
`@apify/input_schema` | 2.0.2 | [CHANGELOG](./packages/input_schema/CHANGELOG.md)
`@apify/log` | 1.1.4 | [CHANGELOG](./packages/log/CHANGELOG.md)
`@apify/markdown` | 1.0.21 | [CHANGELOG](./packages/markdown/CHANGELOG.md)
`@apify/payment_qr_codes` | 0.1.0 | [CHANGELOG](./packages/payment_qr_codes/CHANGELOG.md)
`@apify/salesforce_client` | 1.0.4 | [CHANGELOG](./packages/salesforce_client/CHANGELOG.md)
`@apify/utilities` | 1.2.0 | [CHANGELOG](./packages/utilities/CHANGELOG.md)
