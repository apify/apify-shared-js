...
--------|---------|----------
`@apify/consts` | 1.10.1 | [CHANGELOG](./packages/consts/CHANGELOG.md)
...
`@apify/input_schema` | 2.0.12 | [CHANGELOG](./packages/input_schema/CHANGELOG.md)
`@apify/log` | 1.2.4 | [CHANGELOG](./packages/log/CHANGELOG.md)
`@apify/markdown` | 1.2.5 | [CHANGELOG](./packages/markdown/CHANGELOG.md)
`@apify/payment_qr_codes` | 0.1.1 | [CHANGELOG](./packages/payment_qr_codes/CHANGELOG.md)
`@apify/pseudo_url` | 1.1.5 | [CHANGELOG](./packages/pseudo_url/CHANGELOG.md)
...
`@apify/utilities` | 1.2.13 | [CHANGELOG](./packages/utilities/CHANGELOG.md)
