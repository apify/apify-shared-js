...
`@apify/input_secrets` | 1.1.34 | [CHANGELOG](./packages/input_secrets/CHANGELOG.md)
`@apify/log` | 2.4.0 | [CHANGELOG](./packages/log/CHANGELOG.md)
`@apify/markdown` | 2.1.8 | [CHANGELOG](./packages/markdown/CHANGELOG.md)
...
`@apify/utilities` | 2.8.0 | [CHANGELOG](./packages/utilities/CHANGELOG.md)
