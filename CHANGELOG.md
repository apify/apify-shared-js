...
--------|---------|----------
`@apify/consts` | 1.8.0 | [CHANGELOG](./packages/consts/CHANGELOG.md)
...
`@apify/input_schema` | 2.0.9 | [CHANGELOG](./packages/input_schema/CHANGELOG.md)
`@apify/log` | 1.2.1 | [CHANGELOG](./packages/log/CHANGELOG.md)
`@apify/markdown` | 1.2.2 | [CHANGELOG](./packages/markdown/CHANGELOG.md)
`@apify/payment_qr_codes` | 0.1.1 | [CHANGELOG](./packages/payment_qr_codes/CHANGELOG.md)
`@apify/pseudo_url` | 1.1.2 | [CHANGELOG](./packages/pseudo_url/CHANGELOG.md)
...
`@apify/utilities` | 1.2.10 | [CHANGELOG](./packages/utilities/CHANGELOG.md)
