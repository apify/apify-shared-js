...
--------|---------|----------
`@apify/consts` | 2.21.0 | [CHANGELOG](./packages/consts/CHANGELOG.md)
...
`@apify/input_schema` | 3.5.6 | [CHANGELOG](./packages/input_schema/CHANGELOG.md)
`@apify/input_secrets` | 1.1.36 | [CHANGELOG](./packages/input_secrets/CHANGELOG.md)
`@apify/log` | 2.4.1 | [CHANGELOG](./packages/log/CHANGELOG.md)
`@apify/markdown` | 2.1.10 | [CHANGELOG](./packages/markdown/CHANGELOG.md)
`@apify/payment_qr_codes` | 0.2.0 | [CHANGELOG](./packages/payment_qr_codes/CHANGELOG.md)
`@apify/pseudo_url` | 2.0.31 | [CHANGELOG](./packages/pseudo_url/CHANGELOG.md)
...
`@apify/utilities` | 2.9.1 | [CHANGELOG](./packages/utilities/CHANGELOG.md)
