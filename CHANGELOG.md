...
--------|---------|----------
`@apify/consts` | 1.11.0 | [CHANGELOG](./packages/consts/CHANGELOG.md)
...
`@apify/input_schema` | 2.1.0 | [CHANGELOG](./packages/input_schema/CHANGELOG.md)
`@apify/log` | 1.2.5 | [CHANGELOG](./packages/log/CHANGELOG.md)
`@apify/markdown` | 1.3.0 | [CHANGELOG](./packages/markdown/CHANGELOG.md)
`@apify/payment_qr_codes` | 0.1.1 | [CHANGELOG](./packages/payment_qr_codes/CHANGELOG.md)
`@apify/pseudo_url` | 1.1.6 | [CHANGELOG](./packages/pseudo_url/CHANGELOG.md)
...
`@apify/utilities` | 1.2.14 | [CHANGELOG](./packages/utilities/CHANGELOG.md)
