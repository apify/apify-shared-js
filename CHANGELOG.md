...
`@apify/input_secrets` | 1.1.24 | [CHANGELOG](./packages/input_secrets/CHANGELOG.md)
`@apify/log` | 2.2.16 | [CHANGELOG](./packages/log/CHANGELOG.md)
`@apify/markdown` | 2.0.33 | [CHANGELOG](./packages/markdown/CHANGELOG.md)
`@apify/payment_qr_codes` | 0.2.0 | [CHANGELOG](./packages/payment_qr_codes/CHANGELOG.md)
`@apify/pseudo_url` | 2.0.22 | [CHANGELOG](./packages/pseudo_url/CHANGELOG.md)
...
`@apify/utilities` | 2.7.2 | [CHANGELOG](./packages/utilities/CHANGELOG.md)
