...
export const ACTOR_ENV_VARS = {
    ...
    MCP_CONNECTOR_BASE_URL: 'ACTOR_MCP_CONNECTOR_BASE_URL',
...
export const COMMA_SEPARATED_LIST_ENV_VARS = [ACTOR_ENV_VARS.BUILD_TAGS];
export const JSON_ENCODED_ENV_VARS = [ACTOR_ENV_VARS.STORAGES_JSON];
/**
