...
export class HubspotClient {
    constructor(config, injectedHubspotClient = null) {
        ...
        const ClientClass = injectedHubspotClient || hubspot.Client;
     ...
     * If contact is found this function returns it. If it's not found, this function returns null.
     *
     * @param {String} apifyUserId ID of the user document from mongodb
     * @returns {SimpleHubspotContact|null}
     */
    async searchContactByApifyUserId(apifyUserId) {
     ...
     * @returns {String|null}
     */
    async lookupContactId(apifyUser) {
     ...
     *
     * @param {String} userId ID of the user for who we are looking up account in hubspot
     ...
     *
     * @param {String} contactId ID of the contact in hubspot
     * @param {String} salesRepEmail Email of the main sales representative
     * @return {void}
     */
    async connectOwnerWithContact(contactId, salesRepEmail) {
     ...
     * sent to hubspot.
     *
     * @param {String} hubspotContactId ID of the contact in hubspot we are modifying
     * @param {Object} modifier Data to be modified in the hubspot contact
     * @return undefined
     */
    async updateContact(hubspotContactId, modifier) {
        try {
     ...
     *
     * @param {String} hubspotContactId Id of the user whose contact in hubspot we want to delete
     * @return undefined
     */
    async deleteContact(hubspotContactId) {
     ...
     *
     * @param {String} invoiceNumber Number of the invoice
     * @returns {SimpleHubspotInvoice|null}
     */
    async searchInvoiceByNumber(invoiceNumber) {
     ...
     * If invoice is found this function returns it. If it's not found, this function returns null.
     *
     * @param {String} apifyInvoiceId ID of the invoice document from mongodb
     * @returns {SimpleHubspotInvoice|null}
     */
    async searchInvoiceByApifyInvoiceId(apifyInvoiceId) {
     ...
     *
     * @param {String} hubspotInvoiceId Hubspot invoice ID used to load data for the invoice
     * @return {SimpleHubspotInvoice} invoice data from hubspot
     */
    async getInvoice(hubspotInvoiceId) {
        try {
     ...
     * @param {String} hubspotContactId ID of the hubspot contact who we will associate the invoice to
     * @return {String} ID of the invoice in hubspot
     */
    async createInvoice(invoice, hubspotContactId) {
     ...
     * sent to hubspot.
     *
     * @param {String} hubspotInvoiceId ID of the invoice in hubspot
     * @param {Object} modifier Data to be updated in hubspot
     * @return {void}
     */
    async updateInvoice(hubspotInvoiceId, modifier) {
        try {
     ...
     * @return {void}
     */
    async deleteInvoice(hubspotInvoiceId) {
