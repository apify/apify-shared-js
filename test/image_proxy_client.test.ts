...
const EXPECTED_IMAGE_URL =
    'https://localhost:3000/14110f5a2b817884066da289ce004803b35cfefc/' +
    '687474703a2f2f6578616d706c652e636f6d2f696d6167652e676966';
const EXPECTED_IMAGE_URL_2 =
    'https://localhost:3000/3bb9136ff6f149fce6770d65291f29554b372e11/' +
    '485454503a2f2f6578616d706c652e636f6d2f696d6167652e676966';

const getComplicatedHtml = (imageUrl: string) => {
    return (
        `<img src="${imageUrl}" alt="test image" title="test image"><br>` +
